...
class PharmacyTravelDistance extends Component<PharamcyTravelDistanceProps, PharamcyTravelDistanceState> {
	constructor(props: PharamcyTravelDistanceProps, state: PharamcyTravelDistanceState) {
		super(props, state);
		this.state = {
			distance: 0,
		};
