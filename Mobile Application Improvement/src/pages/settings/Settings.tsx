			...
			<IonList>
				...
				<IonItem>
					...
					>
						...
						<IonSelectOption value="rssb">RSSB – Medical Scheme</IonSelectOption>
						<IonSelectOption value="mmi">MILITARY MEDICAL INSURANCE</IonSelectOption>
						<IonSelectOption value="SONARWA">SONARWA General Insurance Ltd</IonSelectOption>
					</IonSelect>
				</IonItem>
