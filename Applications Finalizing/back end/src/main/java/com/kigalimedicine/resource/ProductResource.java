...
public class ProductResource {
    ...
    public Response getProduct(@QueryParam("search") String searchResult,
            @QueryParam("page") @DefaultValue("0") Integer page, @QueryParam("pharmacyId") Long pharmacyId) {
        try {
            return Response.ok(productService.getProduct(searchResult, page, pharmacyId)).build();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Path("{productId}/inventory-items")
    @GET
    @APIResponses(value = {
            @APIResponse(
                    description = "OK",
    ...
    public Response getProductInventoryItems(@PathParam("productId") Long productId, @QueryParam("sortPrice") @DefaultValue("false") Boolean sortByPrice) {
        try {
            return Response.ok(productService.getProductInventoryItems(productId,sortByPrice)).build();
        } catch (Exception e) {
            return Response.status(401).build();
        }
    }
    ...
    public Response updateProduct(@PathParam("productId") Long productId, @Valid ProductDto product) {
        try {
